        ...
        <div className="px-3/100 screen1360:px-0 max-w-1360 mx-auto pt-8 lg:pt-10">
          ...
          <div className="max-w-375 mx-auto lg:max-w-none grid grid-cols-2 lg:grid-cols-4 gap-6 pb-12 lg:pb-16 items-center">
            ...
            <ul className="tokennomics-bounce col-span-2 relative h-330 lg:h-582 order-1 lg:order-2 z-10">
              ...
              <li className={`absolute cursor-pointer transition-all overflow-hidden rounded-full transform ${bounce === 'team' ? 'scale-110' : ''}`} onMouseLeave={() => setBounce('')} onMouseOver={() => setBounce('team')}><img src={`${HOME_URL}/assets/tokennomics/team.png`} alt="team" /></li>
              ...
              <li className={`absolute cursor-pointer transition-all overflow-hidden rounded-full transform ${bounce === 'presale' ? 'scale-110' : ''}`} onMouseLeave={() => setBounce('')} onMouseOver={() => setBounce('presale')}><img src={`${HOME_URL}/assets/tokennomics/presale.png`} alt="presale" /></li>
              <li className={`absolute cursor-pointer transition-all overflow-hidden rounded-full transform ${bounce === 'liquidity' ? 'scale-110' : ''}`} onMouseLeave={() => setBounce('')} onMouseOver={() => setBounce('liquidity')}><img src={`${HOME_URL}/assets/tokennomics/liquidity.png`} alt="liquidity" /></li>
              ...
              <li className={`absolute cursor-pointer transition-all overflow-hidden rounded-full transform ${bounce === 'partners' ? 'scale-110' : ''}`} onMouseLeave={() => setBounce('')} onMouseOver={() => setBounce('partners')}><img src={`${HOME_URL}/assets/tokennomics/partners.png`} alt="partners" /></li>
              <li className={`absolute cursor-pointer transition-all overflow-hidden rounded-full transform ${bounce === 'farming' ? 'scale-110' : ''}`} onMouseLeave={() => setBounce('')} onMouseOver={() => setBounce('farming')}><img src={`${HOME_URL}/assets/tokennomics/farming.png`} alt="farming" /></li>
              <li className={`absolute cursor-pointer transition-all overflow-hidden rounded-full transform ${bounce === 'fund' ? 'scale-110' : ''}`} onMouseLeave={() => setBounce('')} onMouseOver={() => setBounce('fund')}><img src={`${HOME_URL}/assets/tokennomics/fund.png`} alt="fund" /></li>
            </ul>
