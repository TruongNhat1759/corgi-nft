...
const AnimationCharacterMedium = (props: IProps) => {
  ...
  return (
    <div className="h-full rounded" onClick={loadAnimation} role="none">
      <Stage
        ...
        width={sizeScreen > 1360 ? 92 : 66}
        height={sizeScreen > 1360 ? 92 : 66}
      >
        {spineData && (
          <Spine
            scale={sizeScreen > 1360 ? 0.075 : 0.062}
            x={sizeScreen > 1360 ? 45 : 34}
            y={sizeScreen > 1360 ? 95 : 80}
            spineData={spineData}
            mixes={mixes}
...
export default AnimationCharacterMedium;